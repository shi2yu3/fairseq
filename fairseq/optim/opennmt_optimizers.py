...
@register_optimizer('opennmt')
class OpenNMTOptimizer(FairseqOptimizer):
    def __init__(self, args, model, checkpoint):
        super().__init__(args, model.parameters())
        self._optimizer = Optimizer.from_opt(model, args, checkpoint=checkpoint)
